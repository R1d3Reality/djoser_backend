...
`;function X(){const{formatMessage:c}=(0,p.Z)(),{push:U}=(0,A.k6)(),{collectionTypes:J,singleTypes:b,isLoading:_}=(0,T.G)(),{meta:x,workflows:$,isLoading:N,refetch:q}=(0,Y.n)(),[F,j]=t.useState(null),[ee,B]=t.useState(!1),{del:te}=(0,n.kY)(),{formatAPIError:ne}=(0,n.So)(),G=(0,n.lm)(),{getFeature:ae,isLoading:Z}=(0,O.q)(),{trackUsage:Q}=(0,n.rS)(),se=(0,o.v9)(i._),{allowedActions:{canCreate:H,canDelete:oe}}=(0,n.ss)(se.settings["review-workflows"]),I=ae("review-workflows"),{mutateAsync:le,isLoading:re}=(0,D.useMutation)(async({workflowId:m,stages:K})=>{const{data:{data:k}}=await te(`/admin/review-workflows/workflows/${m}`,{data:K});return k},{onSuccess(){G({type:"success",message:{id:"notification.success.deleted",defaultMessage:"Deleted"}})}}),ie=m=>[...J,...b].find(k=>k.uid===m).info.displayName,de=m=>{j(m)},ce=()=>{j(null)},Ee=async()=>{try{const m=await le({workflowId:F});return await q(),j(null),m}catch(m){return G({type:"warning",message:ne(m)}),null}};return t.useEffect(()=>{!N&&!Z&&I?.[W.Ef]&&x?.workflowCount>parseInt(I[W.Ef],10)&&B(!0)},[Z,N,I,x?.workflowCount,x.workflowsTotal]),t.createElement(t.Fragment,null,t.createElement(C.h4,{primaryAction:H&&t.createElement(n.Qj,{startIcon:t.createElement(y.Z,null),size:"S",to:"/settings/review-workflows/create",onClick:m=>{I?.[W.Ef]&&x?.workflowCount>=parseInt(I[W.Ef],10)?(m.preventDefault(),B(!0)):Q("willCreateWorkflow")}},c({id:"Settings.review-workflows.list.page.create",defaultMessage:"Create new workflow"})),subtitle:c({id:"Settings.review-workflows.list.page.subtitle",defaultMessage:"Manage your content review process"}),title:c({id:"Settings.review-workflows.list.page.title",defaultMessage:"Review Workflows"})}),t.createElement(C.fC,null,N||_?t.createElement(v.k,{justifyContent:"center"},t.createElement(f.a,null,c({id:"Settings.review-workflows.page.list.isLoading",defaultMessage:"Workflows are loading"}))):t.createElement(r.i,{colCount:3,footer:H&&t.createElement(u.c,{icon:t.createElement(y.Z,null),onClick:()=>{I?.[W.Ef]&&x?.workflowCount>=parseInt(I[W.Ef],10)?B(!0):(U("/settings/review-workflows/create"),Q("willCreateWorkflow"))}},c({id:"Settings.review-workflows.list.page.create",defaultMessage:"Create new workflow"})),rowCount:1},t.createElement(g.h,null,t.createElement(a.Tr,null,t.createElement(s.Th,null,t.createElement(l.Z,{variant:"sigma"},c({id:"Settings.review-workflows.list.page.list.column.name.title",defaultMessage:"Name"}))),t.createElement(s.Th,null,t.createElement(l.Z,{variant:"sigma"},c({id:"Settings.review-workflows.list.page.list.column.stages.title",defaultMessage:"Stages"}))),t.createElement(s.Th,null,t.createElement(l.Z,{variant:"sigma"},c({id:"Settings.review-workflows.list.page.list.column.contentTypes.title",defaultMessage:"Content Types"}))),t.createElement(s.Th,null,t.createElement(w.T,null,c({id:"Settings.review-workflows.list.page.list.column.actions.title",defaultMessage:"Actions"}))))),t.createElement(d.p,null,$.map(m=>t.createElement(a.Tr,{...(0,n.X7)({fn(K){K.target.nodeName!=="BUTTON"&&U(`/settings/review-workflows/${m.id}`)}}),key:`workflow-${m.id}`},t.createElement(s.Td,{width:(0,n.Q1)(250)},t.createElement(l.Z,{textColor:"neutral800",fontWeight:"bold",ellipsis:!0},m.name)),t.createElement(s.Td,null,t.createElement(l.Z,{textColor:"neutral800"},m.stages.length)),t.createElement(s.Td,null,t.createElement(l.Z,{textColor:"neutral800"},(m?.contentTypes??[]).map(ie).join(", "))),t.createElement(s.Td,null,t.createElement(v.k,{alignItems:"center",justifyContent:"end"},t.createElement(V,{to:`/settings/review-workflows/${m.id}`,"aria-label":c({id:"Settings.review-workflows.list.page.list.column.actions.edit.label",defaultMessage:"Edit {name}"},{name:m.name})},t.createElement(S.Z,null)),$.length>1&&oe&&t.createElement(h.h,{"aria-label":c({id:"Settings.review-workflows.list.page.list.column.actions.delete.label",defaultMessage:"Delete {name}"},{name:"Default workflow"}),icon:t.createElement(L.Z,null),noBorder:!0,onClick:()=>{de(m.id)}}))))))),t.createElement(n.QH,{bodyText:{id:"Settings.review-workflows.list.page.delete.confirm.body",defaultMessage:"If you remove this worfklow, all stage-related information will be removed for this content-type. Are you sure you want to remove it?"},isConfirmButtonLoading:re,isOpen:!!F,onToggleDialog:ce,onConfirm:Ee}),t.createElement(P.fC,{isOpen:ee,onClose:()=>B(!1)},t.createElement(P.Dx,null,c({id:"Settings.review-workflows.list.page.workflows.limit.title",defaultMessage:"You\u2019ve reached the limit of workflows in your plan"})),t.createElement(P.uT,null,c({id:"Settings.review-workflows.list.page.workflows.limit.body",defaultMessage:"Delete a workflow or contact Sales to enable more workflows."})))))}function z(){const c=(0,o.v9)(i._);return t.createElement(n.O4,{permissions:c.settings["review-workflows"].main},t.createElement(X,null))}},38454:(M,E,e)=>{e.d(E,{c:()=>g});var t=e(85893),n=e(88972),o=e(16607),i=e(26910),v=e(96987),f=e(10574);const r=(0,n.default)(o.x)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
...
`,u=(0,n.default)(o.x)`
  ...
  width: 100%;
  border: none;
`,g=({children:a,icon:s,...l})=>(0,t.jsxs)("div",{children:[(0,t.jsx)(i.i,{}),(0,t.jsx)(u,{as:"button",background:"primary100",padding:5,...l,children:(0,t.jsxs)(v.k,{children:[(0,t.jsx)(r,{"aria-hidden":!0,background:"primary200",children:s}),(0,t.jsx)(o.x,{paddingLeft:3,children:(0,t.jsx)(f.Z,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:a})})]})})]})},94101:(M,E,e)=>{e.d(E,{Q:()=>a});var t=e(85893),n=e(67294),o=e(88972),i=e(62485),v=e(20501),f=e(53342),r=e(96987),u=e(10574);const g=(0,o.default)(v.G)`
